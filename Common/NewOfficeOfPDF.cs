...
namespace Common
{
    public class NewOfficeOfPDF
    {
        public static string ftpHost = "ftp://192.168.1.171:26/";//FTP的ip地址或域名 
        ...
        public static bool DOCConvertToPDF(string sourcePath, string targetPath)//sourcePath：上传文件位置   //targetPath：PDF文件上传位置
        {
            bool result = false;
